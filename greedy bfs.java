...
public class Greedy_BFS
{
    ...
    public Greedy_BFS(int numberOfNodes)
    {
    ...
    public void Greedy_BFS(int adjacencyMatrix[][], int[] heuristicvalues,int source)
    {
        int evaluationNode;
        int destinationNode;
    ...
    public static void main(String... arg)
    {
        ...
        try
        {
            ...
            Greedy_BFS bestFirstSearch = new Greedy_BFS(number_of_vertices);
            bestFirstSearch.Greedy_BFS(adjacency_matrix, heuristicvalues,source);
